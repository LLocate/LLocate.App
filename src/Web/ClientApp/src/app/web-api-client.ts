...
export interface ISheetsClient {
    ...
    deleteSheetItemSetting(id: number): Observable<boolean>;
}
...
export class SheetsClient implements ISheetsClient {
    ...
    deleteSheetItemSetting(id: number): Observable<boolean> {
        let url_ = this.baseUrl + "/api/Sheets/DeleteSheetItemSetting?";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteSheetItemSetting(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteSheetItemSetting(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<boolean>;
                }
            } else
    ...
    protected processDeleteSheetItemSetting(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
